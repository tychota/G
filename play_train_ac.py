...
from dlgo.rl.experience import ExperienceCollector, combine_experience, load_experience
...
def generate_experience(learning_agent, reference_agent, exp_file,
    ...
    experience_files = []
    workers = []
    gpu_frac = FACTOR / float(num_workers)
...
def main():
    ...
    parser.add_argument('--games-per-batch', '-g', type=int, default=3000)
